...
@NoArgsConstructor
@AllArgsConstructor
@Document(indexName = "cms_teacher_label_relation", shards = 3, replicas = 0, refreshInterval = "5s")
public class CmsTeacherLabelRelationElasticSearchIndex implements Serializable {
    ...
    @Field(value = "labelId", type = FieldType.Integer)
    Integer labelId;
